...
const Assistant = () => {
    ...
    const testAssistant = async (question: string) => {
        if (files !== null) {
            alert("name:" + files[0].name);
            alert("size:" + files[0].size);
        }
    };
                ...
                <div className={styles.chatContainer}>
                    ...
                    <div className={styles.chatInput}>
                        ...
                        {/* <QuestionInput2
                            ...
                            onSend={question => testAssistant(question)}
                        /> */}
                    </div>
                </div>
